...
namespace eVekilApplication.Migrations
{
    ...
    [Migration("20190331192849_PaymentTableChanged")]
    partial class PaymentTableChanged
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eVekilApplication.Models.Connect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eVekilApplication.Models.PaymentDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eVekilApplication.Models.Document", b =>
                {
                    ...
                    b.HasOne("eVekilApplication.Models.Payment")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("eVekilApplication.Models.PaymentDocument", b =>
                {
                    ...
                    b.HasOne("eVekilApplication.Models.Payment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
