    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreatedDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CreatedDocuments_Subcategories_SubcategoryId",
                        column: x => x.SubcategoryId,
                        principalTable: "Subcategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CreatedDocuments_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreatedDocuments_SubcategoryId",
                table: "CreatedDocuments",
                column: "SubcategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CreatedDocuments_UserId1",
                table: "CreatedDocuments",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertySubcategories_SubcategoryId",
                table: "PropertySubcategories",
                column: "SubcategoryId");
